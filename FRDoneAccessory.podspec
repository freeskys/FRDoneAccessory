#
#  Be sure to run `pod spec lint FRDoneAccessory.podspec' to ensure this is a
...
Pod::Spec.new do |s|
  ...
  s.author             	 = "Harditya Ramadhan"
  # Or just: s.author    = "Harditya Ramadhan"
  # s.authors            = { "Harditya Ramadhan" => "adit@blezcode.com" }
  # s.social_media_url   = "http://twitter.com/Harditya Ramadhan"
  ...
  s.source_files  = "FRDoneAccessory", "FRDoneAccessory/*.{h,m}"
